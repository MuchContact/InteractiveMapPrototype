...
/**
 * Class: OpenLayers.Control.TFS
 *
 * This Control provides behavior associated with TFS Layers.
 ...
 *
 * The most common example may be a TFS layer containing feature
 ...
 *  - <OpenLayers.Control>
 */
OpenLayers.Control.TFS = OpenLayers.Class(OpenLayers.Control, {
    ...
    /** 
     * APIProperty: Layers
     * List of layers to consider. Must be Layer.TFSs
     * `null` is the default indicating all TFS Layers are queried.
     * {Array} <OpenLayers.Layer.TFS> 
     */
    layers: null,
    ...
    /**
     * Constructor: <OpenLayers.Control.TFS>
     *
     * Parameters:
     * options - {Object} 
     */
     ...
     *     includes data in one of the configured TFS layers.
     *
     * Parameters:
     ...
     *     TFS and may be any valid JSON type.  
     */
    callback: function(infoLookup) {
     ...
     * findLayers method to return ALL TFS layers encountered.
     *
     * Parameters:
     * None
     *
    ...
    findLayers: function() {
        ...
        for (var i=candidates.length-1; i>=0; --i) {
            layer = candidates[i];
            if (layer instanceof OpenLayers.Layer.TFS ) { 
                layers.push(layer);
            }
        }
        return layers;
    ...
    CLASS_NAME: "OpenLayers.Control.TFS"
});
